...
class AppDynamicsJob3(unittest.TestCase):
    ...
    def test_app_dynamics_job(self):
        ...
        driver.find_element_by_link_text("Test16").click()
        driver.get("http://ec2-3-14-11-53.us-east-2.compute.amazonaws.com:8000/teams/teams/example-team-name/members/29/")
        driver.find_element_by_id("id_first_name").click()
        driver.find_element_by_id("id_first_name").clear()
        driver.find_element_by_id("id_first_name").send_keys("Testing")
        ...
        driver.find_element_by_link_text("CRM").click()
        driver.get("http://ec2-3-14-11-53.us-east-2.compute.amazonaws.com:8000/teams/team-dashboard/example-team-name/")
